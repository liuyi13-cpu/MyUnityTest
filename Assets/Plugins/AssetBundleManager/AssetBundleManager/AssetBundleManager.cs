...
{	
	...
	public class AssetBundleManager : MonoBehaviour
	{
        ...
        /// 同步加载Asset
        /// </summary>
        static public T LoadAsset<T>(string assetBundleName, string assetName) where T : Object
        {
            Log(LogType.Info, "Loading " + assetName + " from " + assetBundleName + " bundle");
...
#endif
            {
                ...
                {
                    Debug.LogError("Load Asset Error:" + error);
                    return null;
                }

                if (bundle == null || bundle.m_AssetBundle == null)
                {
                    Debug.LogError("同步加载时无法找到Bundel [" + assetBundleName + "] 移动端不支持直接载入Bundle，请先加载对应Bundle。在PC上请打开 Simulate Model");
                    return null;
                }
