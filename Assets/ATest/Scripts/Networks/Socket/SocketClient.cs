...
public class SocketClient
{
    ...
    /// 写数据
    /// </summary>
    public void WriteMessage(int cmdID, byte[] message)
    {
        if (client == null || !client.Connected)
        {
            Debug.LogError("WriteMessage client.connected----->>false");
            return;
        }
        ...
        using (ms = new MemoryStream())
        {
            ...
            // 消息长度
            Int32 msglen = (ushort)message.Length;
    ...
    void OnRead(IAsyncResult asr)
    {
        try
        {
            ...
            // Debug.Log("get Message!!!!!!!!! " + bytesRead);
    ...
    void OnReceive(byte[] bytes, int length)
    {
        ...
        // Create a new stream with any left over bytes
    ...
    {
        // TODO 192.168.20.166:7777
        ConnectServer("192.168.20.166", 7777);
