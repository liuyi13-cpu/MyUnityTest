...
/// </summary>
public class DB_Skill_level_rule : IDB_BaseInt
{
	const string SQL = @"select _index, id, exp1, exp2, exp3, exp4, exp5, money1, money2, money3, money4, money5 from conf_skill_level_rule";
	...
	static Dictionary<int, IDB_BaseInt> LoadDB()
	{
		...
		DBHelper.Instance.Query(SQL, (reader) =>
		{
			...
			while (reader.Read())
			{
				DB_Skill_level_rule module = new DB_Skill_level_rule()
				{
