...
/// </summary>
public class DB_Equip_part_place : IDB_BaseInt
{
	const string SQL = @"select _index, place, name from conf_equip_part_place";
	...
	static Dictionary<int, IDB_BaseInt> LoadDB()
	{
		...
		DBHelper.Instance.Query(SQL, (reader) =>
		{
			...
			while (reader.Read())
			{
				DB_Equip_part_place module = new DB_Equip_part_place()
				{
